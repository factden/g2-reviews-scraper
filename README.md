...
Pay‑per‑event on Apify: **$0.004 per row**, plus a small $0.005 per-run start fee (less on higher plans). New Apify accounts get **$5 in free credit** (~1,250 rows). See the [actor page](https://apify.com/factden/g2-reviews-scraper?fpr=factden) for current pricing.
